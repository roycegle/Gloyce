...
export default async function USLLCPage() {
  ...
  const features = [
    ...
    {
      icon: Zap,
      title: t("Tiếng Việt toàn trình", "Vietnamese support", "越南语全程支持", "Soporte en vietnamita", "Dukungan bahasa Vietnam"),
      desc: t("Hỗ trợ bằng tiếng Việt từ tư vấn đến nhận hồ sơ", "Full Vietnamese-language support from consultation to document delivery", "从咨询到文件交付提供越南语全程支持", "Soporte completo en vietnamita desde la consulta hasta la entrega de documentos", "Dukungan bahasa Vietnam penuh dari konsultasi hingga pengiriman dokumen"),
    },
    {
      icon: Check,
  ...
  const faqs = [
    {
      q: t("Người Việt Nam có thể mở LLC Mỹ không?", "Can Vietnamese nationals open a US LLC?", "越南人可以在美国开设LLC吗？", "¿Los ciudadanos vietnamitas pueden abrir una LLC en EE.UU.?", "Apakah warga negara Vietnam bisa membuka LLC AS?"),
      a: t(
    ...
    },
    {
      ...
      a: t(
        "EIN (Employer Identification Number) là mã số thuế liên bang Mỹ, tương đương mã số thuế doanh nghiệp tại Việt Nam. Bạn cần EIN để mở tài khoản ngân hàng Mỹ, khai báo thuế, và ký hợp đồng với Amazon/Stripe/PayPal.",
        "An EIN (Employer Identification Number) is the US federal tax ID — equivalent to a Vietnamese business tax code. You need it to open a US bank account, file taxes, and sign contracts with Amazon/Stripe/PayPal.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-5">
              ...
              {t("cho doanh nghiệp Việt Nam", "as a Vietnamese business", "为越南企业", "como empresa vietnamita", "untuk bisnis Vietnam")}
            </h1>
            ...
            <div className="flex flex-wrap gap-4 text-sm text-ink-300">
              {ta(
                {
                  vi: ["Xử lý trong 7–14 ngày", "Giá trọn gói từ $499", "Hỗ trợ tiếng Việt"],
                  en: ["7–14 day processing", "From $499 all-in", "Vietnamese support"],
                ...
                ["7–14 day processing", "From $499 all-in", "Vietnamese support"]
              ).map(f => (
          ...
          <div className="bg-ink-800 border border-gold/20 rounded-2xl p-8 shadow-2xl">
            ...
            <div className="space-y-3 mb-6">
              {ta(
                {
                  vi: ["Phí bang Delaware/Wyoming","Registered Agent (năm đầu)","EIN từ IRS","Operating Agreement chuẩn","Certificate of Formation","Hỗ trợ tiếng Việt trọn trình","Form 5472 & BOI Report cơ bản"],
                  en: ["State filing fee (Delaware/Wyoming)","First-year Registered Agent","EIN from IRS","Standard Operating Agreement","Certificate of Formation","Full Vietnamese-language support","Form 5472 & BOI Report basics"],
