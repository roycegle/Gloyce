// ---------------------------------------------------------------------------
// Gloyce FAQ data
// Each FAQ item has multilingual strings (vi/en/zh/es/id).
// To add a question: append to the relevant category's `faqs` array.
// To add a category: push a new Category object to FAQ_CATEGORIES.
// ---------------------------------------------------------------------------
    ...
    faqs: [
      ...
      },
      {
        ...
        a: {
          ...
          es: "Sí. Gloyce ofrece soporte multilingüe — vietnamita, inglés, chino, español e indonesio. Correos, llamadas, guías y el tablero están disponibles en múltiples idiomas. Esta es una gran ventaja sobre los servicios de EE.UU. o Singapur que carecen de soporte multilingüe.",
          id: "Ya. Gloyce menawarkan dukungan multibahasa — Vietnam, Inggris, Mandarin, Spanyol, dan Indonesia. Email, panggilan, panduan, dan dasbor tersedia dalam berbagai bahasa. Ini adalah keunggulan besar dibanding layanan AS atau Singapura yang tidak memiliki dukungan multibahasa.",
        },
      },
    ],
  },
